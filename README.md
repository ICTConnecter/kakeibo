...
- [x] カメラ機能によるレシート撮影
- [x] 画像のアップロード機能
- [x] GeminiAPIを使用した画像解析
- [x] レシート情報の自動抽出（店名、日付、金額、商品明細など）
...
- [x] デフォルト経費タイプ:
  ...
  - 広告宣伝費
  - その他経費
- [x] カスタム経費タイプの追加・編集・削除
- [x] null許容（経費として計上しない場合はnull）
